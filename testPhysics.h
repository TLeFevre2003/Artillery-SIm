...
private:
   ...
   {  // setup
      ...
      r = linearInterpolation(mapping, 4 /*numMapping*/, d);
      // verify
      assertEquals(r, 5.45); // talk to bro helfrich
   }  // teardown
   ...
   void gravityFromAltitude_5500()
   {
    ...
    /*******************************************************
     * GRAVITY FROM ALTITUDE - one-third between two values, 43,33.3m
     * input:  altitude=43,333m
     * output: gravity=9.793
     ********************************************************/
   void gravityFromAltitude_4333()
   {
      // setup
   ...
   {  // setup
    ...
    /*******************************************************
     * DENSITY FROM ALTITUDE - exactly between two values, 5,500m
     * input:  altitude=5,500m
